    ...
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll("a, button, input[type='submit']").forEach(function (element) {
            element.addEventListener("click", function (event)
            {
                ...
                //// Store the time the loader starts
                //let startTime = Date.now();

                //// Allow navigation or form submission
                //if (element.tagName.toLowerCase() === "a") {
                //    event.preventDefault(); // Prevent immediate navigation
                //    let href = element.href;
                //    setTimeout(() => { window.location.href = href; }, 1000); // Short delay to show loader
                //} else if (element.tagName.toLowerCase() === "input" && element.type === "submit") {
                //    event.preventDefault(); // Prevent immediate form submission
                //    let form = element.closest("form");
                //    setTimeout(() => { form.submit(); }, 1000); // Short delay to show loader
                //}
